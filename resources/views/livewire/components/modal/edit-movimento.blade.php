                ...
                <div class="card-body pb-2">
                    <form role="form text-left" wire:submit.prevent="save">
                        ...
                        <div role="group" aria-label="Basic radio toggle button group">
                            @if ($movimento['tipo_movimento'] === 'R')
                                <input type="radio" class="btn-check" name="btnradio" id="btnradio1"
                                    autocomplete="off">
                                <label
                                    class="text-uppercase text-default text-sm font-weight-bolder btn @if ($movimento['tipo_movimento'] === 'R') btn-success @else btn-outline-success @endif"
                                    for="btnradio1">
                                    Receita
                                </label>
                            @endif
                            ...
                            @if ($movimento['tipo_movimento'] === 'D')
                                <input type="radio" class="btn-check" name="btnradio" id="btnradio2"
                                    autocomplete="off">
                                <label
                                    class="text-uppercase text-default text-sm font-weight-bolder btn @if ($movimento['tipo_movimento'] === 'D') btn-danger @else btn-outline-danger @endif"
                                    for="btnradio2">
                                    Despesa
                                </label>
                            @endif
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn bg-success white-color">Atualizar movimento</button>
                        </div>
                    </form>
                </div>
            </div>
