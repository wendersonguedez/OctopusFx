        ...
        <div class="card card-plain">
            <div class="card-body pb-2">
                <form role="form text-left" wire:submit.prevent="save">
                    ...
                    <div class="d-flex">
                        <input wire:click='setMovimento("R")' type="radio" class="btn-check"
                            name="options-outlined" id="receita" autocomplete="off">
                        <label class="text-uppercase text-default text-sm font-weight-bolder btn btn-outline-success"
                            for="receita">
                            Receita
                        </label>

                        <input wire:click='setMovimento("D")' type="radio" class="btn-check"
                            name="options-outlined" id="despesa" autocomplete="off">
                    ...
                    <div class="form-group">
                        <label for="data" class="text-center text-uppercase text-default text-xxs font-weight-bolder">
                            Data
                        </label>
                        <div class="input-group">
                            <span class="input-group-text" id="basic-addon1">
                            ...
                            <input wire:model="movimento.data_movimento" class="form-control" type="date" id="data">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input wire:model="movimento.descricao" type="text" id="descricao" class="form-control"
                                placeholder="Descrição" aria-label="Username" aria-describedby="basic-addon1">
                        </div>
                    </div>
