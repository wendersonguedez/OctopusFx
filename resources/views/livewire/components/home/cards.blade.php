        ...
        <div class="card">
            <div class="card-body p-3">
                <div class="row">
                    <div class="col-8">
                        <div class="numbers">
                            <p class="text-sm mb-0 text-uppercase font-weight-bold">Total que falta pagar</p>
                            <h5 class="font-weight-bolder">
                                +3,462
                            </h5>
                            <p class="mb-0">
        ...
        <div class="card">
            <div class="card-body p-3">
                <div class="row">
                    <div class="col-8">
                        <div class="numbers">
                            <p class="text-sm mb-0 text-uppercase font-weight-bold">Valor das despesas no mês de maio</p>
                            <h5 class="font-weight-bolder">
                                $103,430
                            </h5>
                            <p class="mb-0">
