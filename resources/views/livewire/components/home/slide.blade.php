<div style="margin-top: 2.5rem">
    <h3 class="title-section-home text-uppercase" style="margin-bottom: -1.2rem">Educação Financeira</h3>
                        ...
                        <div class="row">
                            <div class="col-lg-6 my-auto">
                                ...
                                <p class="lead text-white opacity-8 fadeIn3 fadeInBottom">Free people make free
                                    choices. Free choices mean you get unequal outcomes. You can have freedom,
                                    or you can have equal outcomes. You can’t have both.</p>
                            </div>
                        </div>
                    </div>
                </div>
