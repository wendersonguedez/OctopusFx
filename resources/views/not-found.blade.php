<div class="container">
    <div class="error">
        {{-- <h1>500</h1> --}}
        <h1>Rota indisponivel <strong>:(</strong></h1>
        <p>É necessário que você realize o <a href="{{ route('login') }}" class="text-primary text-gradient font-weight-bold">
                <strong style="color: #5e72e4">login</strong>
            </a>
...
<script src="{{ asset('js/not-found.js') }}"></script>
